...
#define __HYPERVISOR_do_vfp_op						50
/* 
 * VIRTUAL INTERRUPTS
 * 
...
#define VIRQ_LTT_BUF       4  /* G. (DOM0) Trace buffer has records available.  */
...
#define MMUEXT_DCACHE_CLEAN_AREA		16
#define MMUEXT_FLUSH_TLB_PAGE			17
#define MMUEXT_FLUSH_TLB_KERNEL_PAGE	18
#define MMUEXT_FLUSH_PMD_ENTRY			19
#define MMUEXT_CLEAN_PMD_ENTRY			20
#define MMUEXT_FLUSH_USER_TLB_RANGE		21
#define MMUEXT_FLUSH_KERN_TLB_RANGE		22
#define MMUEXT_COHERENT_KERN_RANGE		23
#define MMUEXT_COHERENT_USER_RANGE		24
#define MMUEXT_FLUSH_USER_CACHE_RANGE	25
#define MMUEXT_FLUSH_KERN_DCACHE_PAGE	26
#define MMUEXT_CLEAR_USER_PAGE			27
#define MMUEXT_COPY_USER_PAGE			28
#define MMUEXT_GET_PGD					29
#define MMUEXT_INVALIDATE_I_TLB_ENTRY	30
#define MMUEXT_INVALIDATE_D_TLB_ENTRY	31
#define MMUEXT_DRAIN_WB					32
#define MMUEXT_DMAC_INV_RANGE			33
#define MMUEXT_DMAC_CLEAN_RANGE			34
#define MMUEXT_DMAC_FLUSH_RANGE			35
#define MMUEXT_FLUSH_TLB_ALL			36
#define MMUEXT_FLUSH_TLB_MM				37
#define MMUEXT_DEBUG_TLB_DUMP			38
#define MMUEXT_ASID_CONTROL				39
...
typedef struct mmu_update {
    unsigned long ptr;       /* Machine address of PTE. */
    unsigned long val;       /* New contents of PTE.    */
	unsigned long flags;
} mmu_update_t;
