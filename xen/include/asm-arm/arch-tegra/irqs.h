/* *  linux/include/asm-arm/arch-tegra/irqs.h
 *
 *  Copyright (C) Andrei Warkentin <andreiw@msalumni.com>
 *  Copyright (C) 2010 Google, Inc.
 *  Copyright (C) 2010 Colin Cross <ccross@google.com>
 *  Copyright (C) 2010 Erik Gilling <konkers@google.com>
...
#ifndef __ARCH_TEGRA_IRQS_H
#define __ARCH_TEGRA_IRQS_H
