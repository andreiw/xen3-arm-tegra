...
#define PDE_SET_DOMAIN(dom) ((dom) << PDE_DOMAIN_SHIFT)
#define PDE_IMP             (1 << 9)
#define PDE_SN_B            (1 << 2)
#define PDE_SN_C            (1 << 3)
 ...
 */
#define PDE_SECTION_HV      (PDE_TYPE_SN | PDE_SET_DOMAIN(DOMAIN_HYPERVISOR) | PDE_SN_C | PDE_SN_B | PDE_ACCESS | PDE_P_RW)
#define PDE_TABLE_HV        (PDE_TYPE_PT | PDE_SET_DOMAIN(DOMAIN_HYPERVISOR))
 ...
 */
#define PDE_SECTION_IO     (PDE_TYPE_SN | PDE_SET_DOMAIN(DOMAIN_IO) | PDE_SN_B | PDE_ACCESS | PDE_P_RW)
#define PDE_TABLE_IO       (PDE_TYPE_PT | PDE_SET_DOMAIN(DOMAIN_IO))
